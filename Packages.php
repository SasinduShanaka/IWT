        ...
        <section class="products">
            ...
            <div class="card-container">
                <div class="card"  id="card1">
                    ...
                    <a href="sub_packages.php?package_type=Life Insurance Plan&image=images/fam.png" class="learn-more">Learn More</a>
                    </div>
                </div>
                ...
                <div class="card" id="card3">
                    ...
                    <a href="sub_packages.php?package_type=Medical Plan&image=images/health.png" class="learn-more">Learn More</a>
                    </div>
                </div>
                ...
                <div class="card" id="card4">
                    ...
                    <a href="sub_packages.php?package_type=Investment Plan&image=images/inv.png" class="learn-more">Learn More</a>
                    </div>
                </div>
                ...
                <div class="card" id="card5">
                    ...
                    <a href="sub_packages.php?package_type=Group Plan&image=images/group.png" class="learn-more">Learn More</a>
                    </div>
                </div>
